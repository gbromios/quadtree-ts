...
function getX (this: NodeGeometry): number { return this.position[0]; }
function getY (this: NodeGeometry): number { return this.position[1]; }
function setX (this: NodeGeometry, x: number): void { this.position[0] = x; }
function setY (this: NodeGeometry, y: number): void { this.position[1] = y; }
function getW (this: NodeGeometry): number { return this.size[0]; }
function getH (this: NodeGeometry): number { return this.size[1]; }
function setW (this: NodeGeometry, w: number): void { this.size[0] = w; }
function setH (this: NodeGeometry, h: number): void { this.size[1] = h; }
